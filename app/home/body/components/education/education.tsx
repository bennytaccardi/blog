                    ...
                    <ol>
                        <li>
                            <div className="flex flex-col md:flex-row">
                                <div
                                    className="rounded-full bg-blue-500 border-white border-4 w-12 sm:w-17 h-12 sm:h-17 absolute -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
